      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>123 Soil Street</li>
              <li>Farmland, AG 12345</li>
              <li>Phone: (555) 123-4567</li>
              <li>Email: info@soilinventory.com</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 rounded bg-gray-800 border border-gray-700 focus:outline-none focus:border-green-400"
              />
              <button
                type="submit"
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p>&copy; {new Date().getFullYear()} The Soil Inventory. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
